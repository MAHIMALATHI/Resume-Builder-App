...
const UserDataCollect = () => {
   ...
   const generateCoverLetter = () => {
    ...
    return (
        ...
        <FormControl className='mmy-2' marginTop="2%">
        <Input name='profileImage' width='40%' bgColor='white' type='file' onChange={handleChangePersonal} />
       
        <Input name='name' width='40%' border-color='black' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Your Name' />
        </FormControl>
        <FormControl className='mmy-2'>
         <Input name='award' width='40%' bgColor='white'onChange={handleChangeAwards} placeholder='Enter Awards' />
       
        
        <Input name='profile' width='40%' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Profile' />
        </FormControl>
        <FormControl className='mmy-2'>
        <Input name='address' width='40%' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Address' />

        <Input name='phone' width='40%' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Phone Number' />
        </FormControl>
        <FormControl className='mmy-2'>
        <Input name='email' width='40%' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Email Address' />
        
        <Input name='skill' width='40%' bgColor='white' onChange={handleChangePersonal} placeholder='Enter Skills' />
        </FormControl>
        <FormControl className='mmy-2'>
         <Textarea name='summary' width='80%' bgColor='white'onChange={handleChangePersonal} placeholder='Enter Summary' />
        </FormControl>
        <div id="form-personal" className='mmy-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        <Heading as='h4' size='md' color='black' className='mmy-2'>
                            Projects
                        </Heading>
                        <Switch defaultChecked={true} onChange={() => setCheckProj(!checkProj)} colorScheme='teal' color='white'/>
                    </div>
                    <hr />
                    <Button disabled={checkProj} onClick={handleProjectClick} className='my-3 w-100'  bgColor='#4682B4' colorScheme='teal' variant='solid'>Add Projects</Button>
        ...
        {/* Education Area  */}
                <div id="form-personal" className='mmy-2'>
                    ...
                    <hr />
                    <Button disabled={checkWork} onClick={handleEducationClick} className='my-3 w-100' bgColor='#4682B4'colorScheme='teal' variant='solid'>Add Education</Button>
                ...
                <div id="form-personal" className='mmy-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Switch className="swich" defaultChecked={true} onChange={() => setCheckWork(!checkWork)} colorScheme='teal' />
                    </div>
                    <hr />
                    <Button disabled={checkWork} onClick={handleWorkClick} className='my-3 w-100' bgColor='#4682B4' colorScheme='teal' variant='solid'>Add Experience</Button>
                    {workCount > 0 && workArrTemplate.map((element, index) => <div key={index}>{element}</div>)}
                </div>
               ...
               {/* Awards & Achievement  */}
                <div id="form-personal" className='mmy-2'>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <Button disabled={checkWork} onClick={handleWorkClick} className='my-3 w-100' bgColor='#4682B4' colorScheme='teal'  variant='solid'>Add Awards</Button>
                        {workCount > 0 && workArrTemplate.map((element, index) => <div key={index}>{element}</div>)}
                    <hr />
                    <FormControl isRequired className='mmy-2'>
        ...
        <div>
            <Button bg="#4682B4" marginLeft="50px"color="black" onClick={generateCoverLetter}>Generate Cover Letter</Button><br></br>
            <Button bg="#4682B4" marginLeft="50px"color="black" onClick={generatePortfolio}>Generate Portfolio</Button>
        </div>
